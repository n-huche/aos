...
Coordenados pelo **Chefe de gabinete**. Usados sobretudo via Grok Bot para pesquisa e automação web (ver [grok-bot](./grok-bot.md) · [AGENTS](../../AGENTS.md)).

| Bot | Papel |
|---|---|
| Radar de Vagas | Vagas estágio/júnior; requisitos e mercado |
...
- Pasta do gabinete: `agents/grok-bot/`
