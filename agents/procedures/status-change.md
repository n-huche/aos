...
4. Buscar no vault o caminho antigo e atualizar links externos. Atualizar **Fase:** nas tarefas ligadas (o caminho do projeto muda). Links *dentro* da pasta do projeto (analysis, phases) não mudam.
...
4. Se for de fase: atualizar o caminho em `## Tarefas` da nota da fase.
