...
RECURRING_TYPES = frozenset({"recurring-independent", "recurring-project"})
SERIES_TYPES = RECURRING_TYPES | frozenset({"maintenance"})
ALL_TYPES = UNIQUE_TYPES | SERIES_TYPES
